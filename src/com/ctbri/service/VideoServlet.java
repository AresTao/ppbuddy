...
public class VideoServlet extends HttpServlet{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 279930011100202044L;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try { 
            ...
            if (fields.containsKey("videoId"))
            {
            	...
            	video.setName(fields.get("videoName"));
            	video.setPath(downPath);
            	video.setType(Integer.parseInt(fields.get("videoType")));
            	video.setVideoId(Integer.parseInt(fields.get("videoId")));
            	 
        		CommonPostResp res = VideoOperator.updateVideo(video);
            }else
            {
            	video.setName(fields.get("videoName"));
            	video.setPath(downPath);
            	video.setType(Integer.parseInt(fields.get("videoType")));
            	video.setIsPublish(Integer.parseInt(fields.get("isPublish")));
            	
        		
                DateFormat format1 = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
                String createTime = format1.format(new Date());
        		video.setCreateTime(createTime);
        		video.setPublishTime(createTime);
        		
        		CommonPostResp res = VideoOperator.addVideo(video);
            }
    		
    		
            response.sendRedirect("videoInfoList.jsp");
