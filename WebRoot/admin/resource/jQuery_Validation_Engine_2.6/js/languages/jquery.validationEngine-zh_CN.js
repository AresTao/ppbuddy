...
//                	"regex": /^1\d{10}$/,
                    ...
                    "alertText": "无效的手机号码,只支持13、14、15、18开头的手机号码"
                },
                "email": {
...
//                    "regex": /^((0|([1-9]0[1-9])|([1-9]{1,2}0)|([1-9]{1,3})|(2[0-4][0-9])|(25[0-5]))[.]){3}(0|([1-9]{1,3})|(2[0-4][0-9])|(25[0-5]))$/,
                ...
                "port": {
                    ...
                    "alertText": "端口号必须为数字且应在0－65535之间"
                },
                "ipv4:port": {
	            ...
	            //custom validate 允许输入数字、字母、汉字、"-"、"_",2-20个字符
	            "checkSpecialChar":{
	            	"regex": /^[a-zA-Z\d\u4e00-\u9fa5\-\_]{2,20}$/,
                    "alertText": "输入不合法，请按提示内容输入"
	            },
	            "ajaxCheckDeveloperName": {
                    "url": "checkDeveloperNameIsExist.do",
                    "extraDataDynamic" : "#loginID",//页面要传递到后台的参数
                    "alertText": "此名称已被使用",
                    "alertTextOk": "此名称可以使用",
                    "alertTextLoad": "正在确认此名称是否可用，请稍等..."
                },
	            //ajax验证注册登录表单图片验证码
	            "ajaxCheckValidate": {
                    ...
                    "alertText": "验证码有误",
                    "alertTextOk": "验证码正确",
                    "alertTextLoad": "正在确认验证码是否有效，请稍等..."
                },
                //版本信息输入验证
                "versionInfo": {
                    "regex": /^[a-zA-Z0-9]{1}[a-zA-Z0-9\/\._-]{1,13}[a-zA-Z0-9]{1}$/,
                    "alertText": "允许输入字母、数字、“_”、“-”、“.”，必须你字母或数字开头和结尾，3~15位字符"
                },   
                //验证文本框输入值，控制数据完整性
                "textValue": {
                	"regex": /^[a-zA-Z\d\u4e00-\u9fa5\-\_]{3,50}$/,
                    "alertText": "允许输入数字、字母、汉字、“_”、“-”，3~50位字符"
                },
                "textValue2": {
                	"regex": /^[a-zA-Z0-9-_]{3,50}$/,
                    "alertText": "允许输入数字、字母、“_”、“-”，3~50位字符"
                },
                "apiFuncName": {
                	"regex": /^[a-zA-Z0-9-_*\/\/\.(){}]{3,50}$/,
                	"alertText": "可包含数字、字母、“_”、“-”，“*”，“.”，3~50位字符"
                },
                //添加路由信息，号码前缀校验
                "routingPrefix": {
                	"regex": /^[a-zA-Z0-9-_]{2,10}$/,
                	"alertText": "允许输入数字、字母、“_”、“-”，2~10位字符"
                }
            };
