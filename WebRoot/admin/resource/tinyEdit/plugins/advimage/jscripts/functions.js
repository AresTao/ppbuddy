...
function switchImgType(){
	if(document.forms[0].imgHead.options[0].selected)
		srcField.innerHTML = "<input name=\"srcSrc\" type=\"file\" id=\"srcSrc\" value=\"\" onchange=\"showPreviewImage('file:///'+this.value);document.getElementById('src').value='file:///'+this.value\" />";
	else
		srcField.innerHTML = "<input name=\"srcSrc\" type=\"text\" id=\"srcSrc\" value=\"\" onchange=\"showPreviewImage('http://'+this.value);document.getElementById('src').value='http://'+this.value\"\" />";
}
