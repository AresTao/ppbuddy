	...
	getControlHTML : function(button_name) {
		...
		switch (button_name) {
			...
			case "fontselect":
				...
				var fonts = tinyMCE.getParam("theme_advanced_fonts", iFonts).split(';');
	...
	getEditorTemplate : function(settings, editorId) {
		...
		switch(layoutManager) {
			case "SimpleLayout" : //the default TinyMCE Layout (for backwards compatibility)...
				...
				var pathLocation = tinyMCE.getParam("theme_advanced_path_location", "bottom"); // Compatiblity
				var statusbarLocation = tinyMCE.getParam("theme_advanced_statusbar_location", pathLocation);
				var defVals = {
					theme_advanced_buttons1 : "formatselect,fontselect,fontsizeselect,cut,copy,paste,separator,pastetext,pasteword,selectall,separator,bold,italic,underline,separator,justifyleft,justifycenter,justifyright,justifyfull,bullist,numlist,separator,outdent,indent,separator",
					theme_advanced_buttons2 : "undo,redo,separator,hr,link,unlink,anchor,image,flash,cleanup,forecolor,backcolor,separator,tablecontrols,separator,visualaid,separator,sub,sup,charmap,separator,preview,code"
				};
