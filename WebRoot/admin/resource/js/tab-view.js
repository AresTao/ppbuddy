...
var addEvent=addEvent||function (/*documentElement*/el,/*eventType*/type,/*method*/fn){/*zowell20090209*/
	...
	function showTab(parentId,tabIndex)
	{
		...
		if(activeTabIndex[parentId]>=0){
			...
			img.src = '../resource/style/xtheme/blue/images/tab/tab_right_inactive.gif';
		...
		img.src = '../resource/style/xtheme/blue/images/tab/tab_right_active.gif';
	...
	function rolloverTab()
	{
		if(this.className.indexOf('tabInactive')>=0){
			...
			img.src = '../resource/style/xtheme/blue/images/tab/tab_right_over.gif';
		}
	...
	function initTabs(mainContainerID,tabTitles,activeTab,width,height,closeButtonArray,additionalTab)
	{
		...
		for(var no=0;no<tabTitles.length;no++){
			...
			var title=tabTitles[no];

			var _title="";_id=""
			if(title.indexOf("_")>0){
				var tArr=title.split("_");
				_title=tArr[0];
				_id=tArr[1];
				}else{
				_title=title;	
			...
			//
			span.innerHTML = "<span id='"+escape(_id)+"_title'>"+_title+"</span>";
			span.style.position = 'relative';
			span.id=escape(_id)+"_span";
			aTab.appendChild(span);

			if(closeButtonArray[no]){
				var closeButton = document.createElement('IMG');
				closeButton.src = '../resource/style/xtheme/blue/images/tab/close.gif';
				...
				closeButton.id=escape(_id)+"_close";
				span.innerHTML = span.innerHTML + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';

				var deleteTxt = span.innerHTML+'';
				var self=this;
				addEvent(closeButton,"click",function(){ deleteTab(closeButton.parentNode.innerHTML) });
				//closeButton.onclick = ;
	...
	function getTabIndexByTitle(tabTitle)
	{
		...
		for(var prop in dhtmlgoodies_tabObj){
            var ob=(dhtmlgoodies_tabObj[prop])
			var divs = ob.getElementsByTagName('DIV');
			for(var no=0;no<divs.length;no++){
				if(divs[no].id.indexOf('tabTab')>=0){
