...
if (typeof com.cintel == "undefined") com.cintel = new Object();
if (typeof com.cintel.util == "undefined") com.cintel.util = new Object();
if (typeof com.cintel.www == "undefined") com.cintel.www = {
    is: true,
...
PNG = function (id, src, altsrc) {
    ...
    if (browser.ua.indexOf('msie 5.0') != -1) {
        ...
        png.src = '../css/images/alpha/blank.gif';
...
if (typeof com.cintel.css == "undefined") com.cintel.css = new Object();
com.cintel.css.makeLink = function(href, id, title, media, disabled)
{
    var
...
com.cintel.css.getElementStyle = function(elem, attrstyle, propstyle)
{
...
com.cintel.css.putRule = function(cssIndex, selectorIndex, selector, prop)
{
    try
    {
...
com.cintel.css.attachCssToDOM = function (paths, dom)
{
...
CSSProfile.prototype.featuretests = {
    base: function()
    {
        return com.cintel.css.getElementStyle(this.testelements[0], 'position') == "absolute";
    },
    after: function()
    {
    ...
    layout: function()
    {
        return com.cintel.css.getElementStyle(this.testelements[2], 'hasLayout') == true;
    },
    directchild: function()
    {
        return com.cintel.css.getElementStyle(this.testelements[2], 'overflow') == 'hidden';
    },
    firstchild: function()
    {
        return com.cintel.css.getElementStyle(this.testelements[2], 'direction') == 'rtl';
    },
    lastchild: function()
    {
        return com.cintel.css.getElementStyle(this.testelements[3], 'direction') == 'rtl';
    },
    adjacent: function()
    {
        return com.cintel.css.getElementStyle(this.testelements[3], 'clear') == 'right';
    },
    attribute: function()
    {
        return com.cintel.css.getElementStyle(this.testelements[1], 'cursor') == 'crosshair';
    }
}
...
com.cintel.cssprofile = new CSSProfile();
...
if (typeof com.deconcept.SWFObjectUtil == "undefined") {
    com.deconcept.SWFObjectUtil = new Object();
}
    ...
    getFlashHTML: function() {
        ...
        if (navigator.plugins && navigator.mimeTypes && navigator.mimeTypes.length) {
            ...
            if (browser.isSafari && browser.kitV < 420)
                flashNode = '<img src="../css/images/pixel.gif" name="objectMask" width="' + this.getAttribute('width') + '" height="' + this.getAttribute('height') + '" class="off" />';
