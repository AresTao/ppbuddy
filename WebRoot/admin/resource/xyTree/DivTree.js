...
xyTree.TreeConfig = {
     ...
     * 打开的文件夹，叶节点  xyTree/images/
     */
    rootIcon        : EHM.rootPath+'/resource/xyTree/images/foldericon.gif',
    openRootIcon    : EHM.rootPath+'/resource/xyTree/images/openfoldericon.gif',
    folderIcon      : EHM.rootPath+'/resource/xyTree/images/foldericon.gif',
    openFolderIcon  : EHM.rootPath+'/resource/xyTree/images/openfoldericon.gif',
    fileIcon        : EHM.rootPath+'/resource/xyTree/images/file.gif',
    iIcon           : EHM.rootPath+'/resource/xyTree/images/I.gif',
    lIcon           : EHM.rootPath+'/resource/xyTree/images/L.gif',
    lMinusIcon      : EHM.rootPath+'/resource/xyTree/images/Lminus.gif',
    lPlusIcon       : EHM.rootPath+'/resource/xyTree/images/Lplus.gif',
    tIcon           : EHM.rootPath+'/resource/xyTree/images/T.gif',
    tMinusIcon      : EHM.rootPath+'/resource/xyTree/images/Tminus.gif',
    tPlusIcon       : EHM.rootPath+'/resource/xyTree/images/Tplus.gif',
    blankIcon       : EHM.rootPath+'/resource/xyTree/images/blank.gif',
    buzhongIcon     : EHM.rootPath+'/resource/xyTree/images/buzhong.gif',
    quanzhongIcon   : EHM.rootPath+'/resource/xyTree/images/quanzhong.gif',
    jubuzhongIcon   : EHM.rootPath+'/resource/xyTree/images/jubuzhong.gif',
    loadingIcon     : EHM.rootPath+'/resource/xyTree/images/loading.gif',
...
/**
 * 选中某个节点(用于批量选中)
 * @param {xyTree.Node} node 待选中的节点
 */
xyTree.DivTree.prototype.checkedNode = function(node) {
    //alert(124);
    if (!node) return;

    if (node.child.length != 0)//仅处理叶子节点
        return;
...
xyTree.DivTree.prototype.addNode = function(parent,sub) {
    if(parent!=null)
        parent.add(sub);
}

xyTree.DivTree.prototype.pack = function(name) {
    var arr = this.getAllSelected();
    var d = document.getElementById(name + "_values");
    if (d != null) {
    ...
    for (var i = 0; i < arr.length; i++) {
        if(arr[i].id==null) continue;//跟
        var echkbox = document.createElement("input");
        echkbox.setAttribute("type", "checkbox");
        echkbox.setAttribute("name", name);
        echkbox.setAttribute("value", arr[i].id);
        d.appendChild(echkbox);
...
xyTree.trees_pack="";
/**
 * 树提交之前调用，生成所需的checkbox
 */
xyTree.pack=function(){
    eval(xyTree.trees_pack);
}
