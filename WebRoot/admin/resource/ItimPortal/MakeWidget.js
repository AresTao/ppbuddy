...
var portalTempManager=new function(){
	...
	this.plugs.properties={title:"修改portal属性",selected:false,plug:portalProperties}
	this.isInit=false;
    ...
    this.showSet=function(){
		...
		for(var j in self.plugs){
			...
			var plugBt=$$("div",j+"_Bt","portal_set_left_bt portal_set_left_bt_selected",plugObj.title);
				...
				if(plugObj.selected){
					plugBt.className=plugBt.className.replace("portal_set_left_bt_selected","portal_set_left_bt_unselected");
					plugObj.plug.show();
					}
